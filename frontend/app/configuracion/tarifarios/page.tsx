      ...
      <div className="space-y-6">
        ...
        {prestadores
          ...
          .map((p) => {
            ...
            const isExpanded = !!expandedPrestadores[p.id];
            ...
            return (
              <div key={p.id} className="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden hover:shadow-md transition-all duration-200">
                {/* Prestador header */}
                <div 
                  onClick={() => setExpandedPrestadores(prev => ({ ...prev, [p.id]: !prev[p.id] }))}
                ...
                >
                  ...
                  <button
                    onClick={(e) => {
                      e.stopPropagation(); // Evita colapsar/expandir al hacer click en el botón
                      setForm({
                        ...EMPTY,
                ...
                {isExpanded && (
                  <div className="divide-y divide-slate-100">
                    {groupedServices.map((service) => {
                      ...
                      const isHistoryExpanded = !!expandedHistories[svcKey];
